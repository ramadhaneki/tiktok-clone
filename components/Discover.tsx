...
function Discover() {
  ...
  const activeTopicsStyle  = "xl:border-2 hover:bg-primary xl:border-[#2F4F4F] px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-[#2F4F4F]"
